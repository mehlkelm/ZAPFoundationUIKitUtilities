...
open class ZAPStaticTableViewController: UITableViewController, ZAPStaticTableViewDataSource, ZAPStaticTableViewDelegate {
...
protocol ZAPStaticTableViewDataSource: UITableViewDataSource {
    var sections: [Section] { get set }
    func row(for indexPath: IndexPath) -> Row
}

extension ZAPStaticTableViewDataSource {
...
protocol ZAPStaticTableViewDelegate: UITableViewDelegate {
    var sections: [Section] { get set }
    func row(for indexPath: IndexPath) -> Row
}

extension ZAPStaticTableViewDelegate {
